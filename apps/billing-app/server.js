...
sequelize.sync().then(async () => {
    ...
    app.listen(process.env.BILLING_PORT, process.env.BILLING_HOST, async () => {
        console.log(`Server is running on port ${process.env.BILLING_HOST}:${process.env.BILLING_PORT}`)
        await delay(10000)
